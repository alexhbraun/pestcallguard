    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold font-heading text-plumber-secondary mb-12 text-center">HOW IT WORKS</h2>
          ...
          <div className="bg-neutral-light rounded-xl p-8 md:p-12 shadow-sm border border-gray-100 flex flex-col md:flex-row gap-12">
            <div className="flex-1">
              <h3 className="text-xl font-bold text-plumber-secondary mb-6">When your techs are busy and you can't answer:</h3>
            ...
            <div className="flex-1 flex flex-col justify-center space-y-6">
              <div className="flex items-center gap-3 text-lg font-semibold text-plumber-secondary">
